...
//        inputStream.toByteReadChannel(this@UndertowApplicationRequest)
//    }
//
//    /**
...
//}
//
//private fun InputStream.toByteReadChannel(request: UndertowApplicationRequest): ByteReadChannel {
//    val inputStream = this
//    val channel = ByteChannel(autoFlush = true)
//
//    request.launch(Dispatchers.IO) {
//        try {
...
//            }
//        } catch (e: Exception) {
//            request.call.application.environment.log.debug("Connection closed or error occurred", e)
//        } finally {
//            channel.close()
//        }
//    }
